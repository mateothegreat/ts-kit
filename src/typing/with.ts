...
export type ObjToString<T extends Record<string, string | number | boolean>> =
  FindWhat<What<T>>;
...
export type FalseIfUndefined<T extends boolean | undefined> =
  T extends undefined ? false : T;
